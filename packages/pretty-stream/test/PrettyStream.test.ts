...
import PrettyStream from '../src/index.js';
...
describe('PrettyStream', function () {
    describe('short mode', function () {
        it('data.msg', function (done) {
            ...
            writeStream._write = function (data) {
                ...
                assert.equal(str, '[2016-07-01 00:00:00] \u001b[36mINFO\u001b[39m Ghost starts now.\n');
                done();
            };
        ...
        it('data.err', function (done) {
            ...
            writeStream._write = function (data) {
                const str = data.toString();
                assert.equal(str, '[2016-07-01 00:00:00] \u001b[31mERROR\u001b[39m message\n\u001b[31m\n\u001b[31mHey Jude!\u001b[39m\n\n\u001b[1m\u001b[37mError Code: \u001b[39m\u001b[22m\n    \u001b[90mHEY_JUDE\u001b[39m\n\n\u001b[90m----------------------------------------\u001b[39m\n\n\u001b[90mstack\u001b[39m\n\u001b[39m\n');
                done();
            };
        ...
        it('data.req && data.res', function (done) {
            ...
            writeStream._write = function (data) {
                const str = data.toString();
                assert.equal(str, '[2016-07-01 00:00:00] \u001b[36mINFO\u001b[39m "GET /test" \u001b[32m200\u001b[39m 39ms\n');
                done();
            };
        ...
        it('data.req && data.res && data.err', function (done) {
            ...
            writeStream._write = function (data) {
                const str = data.toString();
                assert.equal(str, '[2016-07-01 00:00:00] \u001b[31mERROR\u001b[39m "GET /test" \u001b[33m400\u001b[39m 39ms\n\u001b[31m\n\u001b[31mmessage\u001b[39m\n\n\u001b[90m----------------------------------------\u001b[39m\n\n\u001b[90mstack\u001b[39m\n\u001b[39m\n');
                done();
            };
    ...
    describe('long mode', function () {
        ...
        it('data.err', function (done) {
            ...
            writeStream._write = function (data) {
                const str = data.toString();
                assert.equal(str, '[2016-07-01 00:00:00] \u001b[31mERROR\u001b[39m\n\u001b[31m\n\u001b[31mHey Jude!\u001b[39m\n\n\u001b[90m----------------------------------------\u001b[39m\n\n\u001b[90mstack\u001b[39m\n\u001b[39m\n\u001b[90m\u001b[39m\n');
                done();
            };
        ...
        it('data with no time field', function (done) {
            ...
            writeStream._write = function (data) {
                const str = data.toString();
                assert.equal(str, `[2024-12-15 13:17:00] \u001b[36mINFO\u001b[39m Ghost starts now.\n`);
                done();
            };
    ...
    describe('timezone handling', function () {
        it('should display provided timestamps consistently', function (done) {
            ...
            writeStream._write = function (data) {
                ...
                assert.equal(str.includes('[2016-07-01 00:00:00]'), true);
                assert.equal(str.includes('INFO'), true);
                assert.equal(str.includes('Test message'), true);
                done();
            };
        ...
        it('should handle ISO 8601 timestamps and convert to local time', function (done) {
            ...
            writeStream._write = function (data) {
                ...
                const timestampMatch = str.match(/^\[(\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2})\]/);
                ...
                assert.equal(str.includes('INFO'), true);
                assert.equal(str.includes('ISO timestamp test'), true);
                done();
            };
        ...
        it('should handle timestamps with timezone offsets', function (done) {
            ...
            writeStream._write = function (data) {
                ...
                assert.equal(str.includes('INFO'), true);
                assert.equal(str.includes('Timezone offset test'), true);
                done();
            };
        ...
        it('should work correctly in different timezones', function (done) {
            ...
            writeStream._write = function (data) {
                ...
                assert.equal(str.includes('[2016-07-01 00:00:00]'), true);
                assert.equal(str.includes('String timestamp'), true);
                done();
            };
        ...
        it('regression test: string timestamps should not be affected by timezone offset', function (done) {
            ...
            writeStream._write = function (data) {
                ...
                assert.match(str, /^\[2016-07-01 00:00:00\]/);
                assert.equal(str.includes('Regression test'), true);
                done();
            };
    ...
    describe('edge paths', function () {
        ...
        it('accepts plain object writes and stringifies internally', function (done) {
            ...
            writeStream._write = function (data) {
                const str = data.toString();
                assert.equal(str.includes('Object input'), true);
                done();
            };
        ...
        it('renders raw errorDetails when parsing details fails', function (done) {
            ...
            writeStream._write = function (data) {
                const str = data.toString();
                assert.equal(str.includes('Details:'), true);
                assert.equal(str.includes('not-json-details'), true);
                done();
            };
        ...
        it('renders parsed object errorDetails payloads', function (done) {
            ...
            writeStream._write = function (data) {
                const str = data.toString();
                assert.equal(str.includes('Details:'), true);
                assert.equal(str.includes('CODE1'), true);
                done();
            };
        ...
        it('renders non-object additional fields', function (done) {
            ...
            writeStream._write = function (data) {
                const str = data.toString();
                assert.equal(str.includes('plain-extra-value'), true);
                done();
            };
        ...
        it('colors 500 status code as red', function (done) {
            ...
            writeStream._write = function (data) {
                const str = data.toString();
                assert.equal(str.includes('\u001b[31m500\u001b[39m'), true);
                done();
            };
        ...
        it('colors 301 status code as cyan', function (done) {
            ...
            writeStream._write = function (data) {
                const str = data.toString();
                assert.equal(str.includes('\u001b[36m301\u001b[39m'), true);
                done();
            };
        ...
        it('colors <200 status code with default color', function (done) {
            ...
            writeStream._write = function (data) {
                const str = data.toString();
                assert.equal(str.includes('\u001b[39m100\u001b[39m'), true);
                done();
            };

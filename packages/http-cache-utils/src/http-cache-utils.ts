interface RequestLike {
    get(header: string): string | false | undefined;
}
...
export const isReqResUserSpecific = (req: RequestLike, res: ResponseLike): string | false | undefined => {
 ...
 *
 */
export const cacheControlValues: Record<string, string> = {

...
import DatabaseInfo from '../src/index.js';

interface BuildKnexOptions {
    client: string;
    version?: string;
    rawResult?: [[{ version: string }]];
    rawReject?: Error;
}

function buildKnex({client, version = '0.0.0', rawResult, rawReject}: BuildKnexOptions): Knex {
    return {
        client: {
            config: {client},

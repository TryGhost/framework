...
import EmailMockReceiver from '../src/index.js';

describe('Email mock receiver', function () {
    let snapshotManager: { assertSnapshot: sinon.SinonSpy };
    let emailMockReceiver: EmailMockReceiver;
    ...
    it('Can initialize', function () {
        assert.ok(new EmailMockReceiver({snapshotManager: {assertSnapshot: sinon.spy()}}));
    });
